...
import createTagValidator from "../middlewares/validations/tag.validator.js";
import { Router } from "express";

const routerTag = Router();

routerTag.post('/tags', authMiddleware, authAdminMiddleware, createTagValidator, createTag);
